    ...
    <footer className="bg-gray-800 text-black p-4 mt-8">
      <div className="container d-flex justify-content-center align-items-center p-3">
        <div className="p-2 text-center">
          <a href='https://github.com/PhilippSeidel'>
        ...
        <div className="p-2 text-center">
          <a href='https://www.linkedin.com/in/philipp-seidel-7ab3b5219/'>
        ...
        <div className="p-2 text-center">
          <a href='https://www.instagram.com/phantastischer_photo_philipp/'>
      ...
      <p className="text-center">&copy; 2025 Philipp Seidel</p>
    </footer>
  );
};
